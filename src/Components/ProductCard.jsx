        ...
        <div className="flex items-end justify-between mt-3">
          ...
          <div onClick={(e)=> {e.stopPropagation()}} className="text-primery">
            {!cartItems[product._id] ? (
              <button
                className="flex items-center justify-center gap-1 bg-primery/10 border border-primery/40 md:w-[80px] w-[64px] h-[34px] rounded cursor-pointer "
              ...
              <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-primery/25 rounded select-none">
                <button
